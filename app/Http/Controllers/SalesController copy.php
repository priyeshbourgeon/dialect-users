...
class SalesController extends Controller
{
    ...
    public function setInterested($id){
        ...
        $mail->services                = $enquiry->services;
        $mail->country_id              = $enquiry->country_id;
        $mail->region_id               = $enquiry->region_id;
        $mail->subject                 = $enquiry->subject;
        $mail->body                    = $enquiry->body;
        $mail->from_id                 = $company_id;
        $mail->timeframe               = $enquiry->timeframe;
        $mail->to_id                   = $enquiry->from_id;
        $mail->sender_type             = 'sales';
        $mail->reference_no            = $enquiry->id;
        $mail->isVerified              = $enquiry->isVerified;
        $mail->Is_Drafted              = $enquiry->Is_Drafted;
        $mail->Is_Limitted             = $enquiry->Is_Limitted;
