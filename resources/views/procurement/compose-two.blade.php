                     ...
                     <form action="{{ route('procurement.send') }}" method="post" enctype="multipart/form-data" >
                        ...
                        <div class=" form_wraper">
                           <div class=" form_group">
                              ...
                              <div class="uk-form-controls">
                                 <input name="subject" class="uk-input" id="form-stacked-text" type="text"
                                    placeholder="Some text..." value="{{ old('subject') }}">
                              </div>
                              @error('subject')
                           ...
                           <div uk-grid>
                              ...
                              <div class= "form_group">
                                 <label class="uk-form-label" for="form-stacked-text">
                                     ...
                                     Send as limited enquiry 
                                     <i class="fa fa-info-circle" uk-tooltip="title: Description abou limited enquiry"></i>
                                 </label>
                                 </div>
                              </div>
                           </div>
                           <div class="uk-text-right">
                              ...
                              <button name="submit" value="save" class="btn_com uk-modal-close" onclick="return confirm('Send Mail?');"
