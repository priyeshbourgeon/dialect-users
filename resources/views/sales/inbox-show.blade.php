                                ...
                                <div class="uk-overflow-auto table_ct">
                                    <article class="uk-article">
                                        ...
                                        <div class="uk-overflow-auto table_ct">
                                            ...
                                            <form action="{{ route('sales.sendreply') }}" method="post"
                                                    ...
                                                    <div>
                                                        <div class=" form_group">
                                                            <label class="uk-form-label"
                                                                for="form-stacked-text">Reply</label>
                                                ...
                                                <div class="uk-width-expand@1-1">
                                                    <div class=" form_group">
                                                        <label class="uk-form-label"
                                                            for="form-stacked-text">Attachment</label>
                                                        <div class="uk-form-controls">
                                            ...
                                            @else
                                            <p style="color:red">This enquiry has been expired on
                                                {{ \Carbon\Carbon::parse($mail->request_time)->format('d-m-Y') }}</p>
                                            @endif
                                        </div>
                                    </article>
