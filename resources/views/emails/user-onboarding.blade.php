...
<p style="font-size: 14px; line-height: 170%;">Dear {{ $users['name'] }}</p>
<p style="font-size: 14px; line-height: 170%; text-align: center;"><span style="font-size: 16px; line-height: 27.2px;"></span>We, Dialectb2b.com, are happy to let you know that,
your organization successfully created account with us. Please complete your account training from the below link.</p>
<p style="font-size: 14px; line-height: 170%;">&nbsp;</p>
<p style="font-size: 14px; line-height: 170%;">&nbsp;<a href="{{ url('onboarding/'.$users['token']) }}">{{ url('onboarding/'.$users['token']) }}</a></p>
